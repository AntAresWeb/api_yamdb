...
Меня зовут Андрей Давыдов. У меня есть полуторалетний опыт программирования на Python, языке программирования, который мне очень нравится своей доступностью и легкостью.
Этот проект был создан через полгода моего знакомства с языком.
